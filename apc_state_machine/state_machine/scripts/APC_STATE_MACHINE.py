...
if __name__ == '__main__':
    ...
    with sm_perception:
        ...
        sm_perception.add('toggle_lip_off', ToggleBinFillersAndTote(action='lip_off'),
           transitions={'succeeded':'move_to_look_into_shelf_pose',
            'failed': 'shelf_scan'})

        sm_perception.add('move_to_look_into_shelf_pose', MoveRobotToNamedPose(movegroup=limb + 'arm',
                        name_prefix=limb + 'look_into_'),
    ...
    with sm_grasp:
        ...
        sm_grasp.add('move_object_back_out', MoveRobotToRelativePose(movegroup=limb + 'arm_cartesian',
                         ...
                         velocity_scale=1.0),
          transitions={'succeeded':'move_sucker_infront_of_bin_after',
                       'failed':'move_sucker_infront_of_bin_after','aborted':'move_sucker_infront_of_bin_after'})

        sm_grasp.add('move_sucker_infront_of_bin_after', MoveRobotToNamedPose(movegroup=limb + 'arm',
                        name_prefix=limb + 'post_suck_in_'),
        ...
        sm_grasp.add('move_back_out_no_object', MoveRobotToRelativePose(movegroup=limb + 'arm_cartesian',
                         pose_frame_id='/shelf', relative_pose=Pose(position=Point(0,0,-0.45),orientation=Quaternion(0,0,0,1)),
                         velocity_scale=1.0),
          transitions={'succeeded':'move_sucker_infront_of_bin_after_no_object',
                       'failed':'track_number_of_grasp_attempts','aborted':'track_number_of_grasp_attempts'})

        sm_grasp.add('move_sucker_infront_of_bin_after_no_object', MoveRobotToNamedPose(movegroup=limb + 'arm',
                        name_prefix=limb + 'ready_to_suck_in_'),
